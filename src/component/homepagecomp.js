...
import CartDisplay from "./cartItem/cartitem"
    ...
    <div>
      <Router>
        ...
        <Switch>
          ...
          <PrivateRouter exact path="/inputitem" component={ImportItemContainer}/> 
          <Route exact path="/login" component={LoginContainer}/> 
          <Route exact path="/cartitems" component={CartDisplay}/>
          <Route exact path="/contactus" component={ContactUs} />
          <Route exact path="/:category" component={DisplayCategory}/>
          <Route exact path="/:category/:productName/:_id" component={ProductDisplay} />
