...
import {
  ...
  inputformValidator,
} from "../../utility/validation/inputItemvalidation";
        ...
        >
          {({
            ...
            <Form className="d-flex justify-content-center ">
              <FormGroup className="mt-4 iteminput">
                ...
                <div className="">
                  <Label for="exampleCity">productName</Label>
                  <Input
                    type="text"
                    name="productName"
                ...
                <div className="">
                  <Label for="exampleCity">productCost</Label>
                  <Input
                    type="text"
                    name="productCost"
                ...
                <div className="">
                  <Label for="exampleZip">productDetail</Label>
                  <Input
                    type="text"
                    name="productDetail"
                ...
                <div>
                    <Label for="exampleSelect">warranty</Label>
                    <Input
                      type="select"
                      name="warranty"
                ...
                <div className="mt-4 mb-4">
                  ...
                  <div className="text-success font-weight-bold">{props.response}</div>
